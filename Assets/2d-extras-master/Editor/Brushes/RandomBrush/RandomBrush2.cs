...
namespace UnityEditor.Tilemaps
{
    ...
    /// </summary>
    [CustomEditor(typeof(RandomBrush2))]
    public class RandomBrush2Editor : GridBrushEditor
    {
        private RandomBrush2 randomBrush { get { return target as RandomBrush2; } }
        ...
        public override void PaintPreview(GridLayout grid, GameObject brushTarget, Vector3Int position)
        {
            if (randomBrush.randomTileSets != null && randomBrush.randomTileSets.Length > 0)
            {
                ...
                foreach (var startLocation in new RandomBrush2.SizeEnumerator(min, min + randomBrush.size, randomBrush.randomTileSetSize))
                {
