...
namespace UnityEditor.Tilemaps
{
    ...
    [CustomGridBrush(false, false, false, "Random Brush GroundBottom2")]
    public class RandomBrush3 : GridBrush
    {
    ...
    /// </summary>
    [CustomEditor(typeof(RandomBrush3))]
    public class RandomBrush3Editor : GridBrushEditor
    {
        private RandomBrush3 randomBrush { get { return target as RandomBrush3; } }
        ...
        public override void PaintPreview(GridLayout grid, GameObject brushTarget, Vector3Int position)
        {
            if (randomBrush.randomTileSets != null && randomBrush.randomTileSets.Length > 0)
            {
                ...
                foreach (var startLocation in new RandomBrush3.SizeEnumerator(min, min + randomBrush.size, randomBrush.randomTileSetSize))
                {
